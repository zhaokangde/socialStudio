  ...
  <view class="service-evaluation">
    ...
    <view class="main">
      <view class="main-evaluation-score">
        <image v-for="(item, index) in scoreList" :key="index" class="score-star" :data-score="item" :src="'/static/static/images/star' + (item > score ? '-grey': '') + '.png'" @tap="handleScore"></image>
      </view>
