...
<view class="contain">
  ...
  <view class="view">
    <view class="view-image-text" @tap="personal">
      <image class="image-radius" :src="config.avatar?config.avatar: 'https://sdk-web-1252463788.cos.ap-hongkong.myqcloud.com/component/TUIKit/assets/avatar_21.png'"></image>
     <view class="text-container">
      <view class="name">{{config.nick?config.nick:"提莫"}}
      <text class="hasname" v-if="hasname">(暂无昵称) </text></view>
